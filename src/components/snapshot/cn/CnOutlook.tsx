  ...
  return (
    <MacroCard title="A股三段式方法论" badge="谨慎乐观">
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        {[
          { title: '证据', color: 'var(--green)', bg: 'rgba(8,153,129,0.06)', bdr: 'rgba(8,153,129,0.2)', items: evidence },
          { title: '证伪', color: 'var(--red)', bg: 'rgba(242,54,69,0.06)', bdr: 'rgba(242,54,69,0.2)', items: falsify },
          { title: '行动', color: 'var(--accent-blue)', bg: 'rgba(59,130,246,0.06)', bdr: 'rgba(59,130,246,0.2)', items: action },
        ].map(s => (
