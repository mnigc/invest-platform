...
import { zScore, percentileRank } from '../../../../lib/analysis'
...
export const GET = withCache(async () => {
  try {
    ...
    const currentDeviation10y = deviations10y.length > 0 ? (() => {
      const last = t10yMap.get(latestDate)
      return last != null ? last - FED_TARGET : null
    })() : null
