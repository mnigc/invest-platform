...
INDICATORS = {
    ...
    ("CPILFESL", "US"): dict(zh="核心 CPI（剔除食品能源）", en="Core CPI", cat="经济数据", sub="通胀",
                             unit="指数", freq="monthly", source="fred", series="CPILFESL"),
    ("PCEPI", "US"): dict(zh="PCE 物价指数", en="PCE Price Index", cat="经济数据", sub="通胀",
                          unit="指数", freq="monthly", source="fred", series="PCEPI"),
    ("PCEPILFE", "US"): dict(zh="核心 PCE（联储政策锚）", en="Core PCE Price Index", cat="经济数据", sub="通胀",
                             unit="指数", freq="monthly", source="fred", series="PCEPILFE"),
    ("PPIACO", "US"): dict(zh="PPI 生产者价格指数", en="PPI All Commodities", cat="经济数据", sub="通胀",
                           unit="指数", freq="monthly", source="fred", series="PPIACO"),
